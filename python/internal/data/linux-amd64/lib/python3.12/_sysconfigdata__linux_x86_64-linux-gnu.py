...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BLDSHARED': 'musl-clang -shared -L/tools/deps/lib -Wl,--exclude-libs,ALL '
              '-L/tools/deps/libedit/lib -LModules/_hacl -static',
 'BOOTSTRAP_HEADERS': '\\',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'CC': 'musl-clang',
 'CCSHARED': '-fPIC',
 'CFLAGS': '-fno-strict-overflow -fno-strict-aliasing -DNDEBUG -g -O3 -Wall '
 ...
 'CONFIG_ARGS': "'--build=x86_64-unknown-linux-gnu' "
                ...
                "-L/tools/deps/libedit/lib -LModules/_hacl -static' 'CPPFLAGS= "
                '-fPIC -I/tools/deps/include -I/tools/deps/include/ncursesw '
                "-I/tools/deps/libedit/include -static'",
 ...
 'LIBEXPAT_CFLAGS': '-fno-strict-overflow -fno-strict-aliasing -DNDEBUG -g -O3 '
                    '-Wall -fPIC -I/tools/deps/include '
                    '-I/tools/deps/include/ncursesw '
                    '-I/tools/deps/libedit/include -static -flto=thin -g '
 ...
 'LIBHACL_CFLAGS': '-I./Modules/_hacl/include -D_BSD_SOURCE -D_DEFAULT_SOURCE '
                   '-fno-strict-overflow -fno-strict-aliasing -DNDEBUG -g -O3 '
                   '-Wall -fPIC -I/tools/deps/include '
                   '-I/tools/deps/include/ncursesw '
                   '-I/tools/deps/libedit/include -static -flto=thin -g '
                   '-std=c11 -Werror=implicit-function-declaration '
 ...
 'MODLIBS': '-lbz2         -lcrypt   -lffi -ldl  -lm  -lncursesw  -lpanelw '
            ...
            '-lrt      -l:libHacl_Hash_SHA2.a    -lsqlite3  -lssl '
            '-lcrypto         -ltcl8.6 -ltk8.6 -lX11 -lxcb -lXau   '
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-fno-strict-overflow -fno-strict-aliasing '
                             '-DNDEBUG -g -O3 -Wall -fPIC '
                             '-I/tools/deps/include '
                             '-I/tools/deps/include/ncursesw '
                             '-I/tools/deps/libedit/include -static -flto=thin '
                             '-g -std=c11 '
                             '-Werror=implicit-function-declaration '
 ...
 'PY_CFLAGS': '-fno-strict-overflow -fno-strict-aliasing -DNDEBUG -g -O3 -Wall '
              '-fPIC -I/tools/deps/include -I/tools/deps/include/ncursesw '
              '-I/tools/deps/libedit/include -static',
 ...
 'PY_CORE_CFLAGS': '-fno-strict-overflow -fno-strict-aliasing -DNDEBUG -g -O3 '
                   '-Wall -fPIC -I/tools/deps/include '
                   '-I/tools/deps/include/ncursesw '
                   '-I/tools/deps/libedit/include -static -flto=thin -g '
                   '-std=c11 -Werror=implicit-function-declaration '
 ...
 'PY_STDMODULE_CFLAGS': '-fno-strict-overflow -fno-strict-aliasing -DNDEBUG -g '
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': '_PYTHON_PROJECT_BASE=/build/Python-3.12.0 '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
               '/build/Python-3.12.0/`cat pybuilddir.txt`:)./Lib '
               '_PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__linux_x86_64-linux-gnu '
               '/tools/host/bin/python3.12',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': '_PYTHON_PROJECT_BASE=/build/Python-3.12.0 '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
               '/build/Python-3.12.0/`cat pybuilddir.txt`:)./Lib '
               '_PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__linux_x86_64-linux-gnu '
