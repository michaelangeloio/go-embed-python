...
build_time_vars = {'ABIFLAGS': '',
 ...
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/build/Python-3.11.5/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/build/Python-3.11.5/lcov-report',
 ...
 'PYTHONPATH': '',
 'PYTHON_FOR_BUILD': '_PYTHON_PROJECT_BASE=/build/Python-3.11.5 '
                     '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
                     'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
                     '/build/Python-3.11.5/`cat pybuilddir.txt`:)./Lib '
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/build/Python-3.11.5',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/build/Python-3.11.5 '
               '_PYTHON_PROJECT_BASE=/build/Python-3.11.5 '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
               '/build/Python-3.11.5/`cat pybuilddir.txt`:)./Lib '
               '_PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__linux_aarch64-linux-gnu '
               '/tools/pyhost/bin/python3.11',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/build/Python-3.11.5 '
               '_PYTHON_PROJECT_BASE=/build/Python-3.11.5 '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
               '/build/Python-3.11.5/`cat pybuilddir.txt`:)./Lib '
 ...
 'abs_builddir': '/build/Python-3.11.5',
 'abs_srcdir': '/build/Python-3.11.5',
